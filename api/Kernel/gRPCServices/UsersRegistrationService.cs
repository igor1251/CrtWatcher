...
{
    public class UsersRegistrationService : UsersService.UsersServiceBase
    {
        IDbStore _store;
        ILogger<UsersRegistrationService> _logger;
        ...
        public UsersRegistrationService(IDbStore store,
                                        ILogger<UsersRegistrationService> logger)
        {
            _store = store;
            _logger = logger;
        }
